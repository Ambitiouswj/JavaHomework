...
public class GradeAdmin {
    ...
    public static void studentSelectCourse() throws Exception{
        ...
        int stuNo = InputErrorCheck.inputIntegerErrorCheck();
        ...
        if (s != null) {
            while (true) {
                ...
                CoursesAdmin.printCourses(selectCourses);
                System.out.println("-----------------------------");
                System.out.println("--------未选课程------------");
                List<Course> noSelectCourses = GradeDAO.findCoursesSelectBystudent(s, false);
                CoursesAdmin.printCourses(noSelectCourses);
                System.out.println("-----------------------------");
                System.out.println("输入课程编号：-1——退出");
                int courseNo = InputErrorCheck.inputIntegerErrorCheck();
                if (courseNo == -1) {
                    break;
                }
    ...
    public static void inputGrade() throws Exception {
        //打印所有课程
        CoursesAdmin.printCourses(CourseDAO.findCourse(""));
                ...
                if (stuNo == -1) {
                    ...
                    if (stu != null) {
                        ...
                        if (g != null) {
                            ...
                            double m = InputErrorCheck.inputIntegerErrorCheck();
